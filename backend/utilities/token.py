...
This module provides utilities for handling JSON Web Tokens (JWT) in the FastAPI application.
It includes functions for creating and verifying access tokens, as well as a dependency
to retrieve the current user based on the provided token.
"""
